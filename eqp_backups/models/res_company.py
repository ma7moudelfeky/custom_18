...
class ResCompany(models.Model):
    ...
    @api.constrains("eqp_backups_enable_drive", "eqp_backups_enable_dropbox")
    def _check_eqp_backups_enable_drive_dropbox(self):
        for company in self:
            if company.eqp_backups_enable_dropbox:
                try:
            ...
            if company.eqp_backups_enable_drive:
                try:
