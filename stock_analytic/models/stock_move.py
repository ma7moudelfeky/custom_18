...
class StockMove(models.Model):
    ...
    @api.constrains('sale_line_id', 'product_id')
    def _check_sale_line_id(self):
        """ Validate sale_line_id """
        for rec in self:
            if rec.sale_line_id and rec.sale_line_id.analytic_distribution:
                rec.analytic_distribution = rec.sale_line_id.analytic_distribution
